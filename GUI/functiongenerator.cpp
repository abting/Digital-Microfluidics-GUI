...
//void FunctionGenerator::send_funcgenInfo(float infotype, float value, float waveformCode)
//{
//    int i = 0;
...
//              waveform ="SINusoid";
//            }
//            else if (waveformCode == 2){
//                waveform ="SQUare";
//            }
//            else if (waveformCode == 3){
//                waveform ="TRIangle";
//            }
//        }
...
//        if(waveformCode == 0){
//            string_info << info << value << "\n";
//        }
//        else if (waveformCode >0){
//            string_info << info << waveform << "\n";
//        }
//        //strcpy(stringinput, "VOLTage 0.05 \n");
//        status = viWrite(instr, (ViBuf)string_info.str().c_str(), (ViUInt32)(string_info).str().size(), &writeCount);
